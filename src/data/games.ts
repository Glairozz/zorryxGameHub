...
export const games: Game[] = [
  ...
  },
  {
    ...
    name: "Drunk Cards",
    description:
      "A fun card-based drinking game with random challenges and prompts. Perfect for parties and group gatherings.",
    instructions: [
  ...
  },
  {
    ...
    name: "Who's the Spy",
    description:
      "A social deduction game where players try to identify the hidden spy among them. Lie, bluff, and deduce your way to victory.",
    instructions: [
  ...
  },
  {
    ...
    name: "King's Cup",
    description:
      "The classic King's Cup drinking card game with digital card draws and rules. A perfect party game for groups.",
    instructions: [
